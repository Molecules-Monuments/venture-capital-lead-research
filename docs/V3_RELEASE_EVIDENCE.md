...
(**364 tests, 30/30** base checks), and each opt-in gate individually —
...
audit remediation added one hundred and fifty-four in total; the per-suite figures in the table
...
## Passing evidence (executed 2026-07-23; last re-executed 2026-08-20)
...
| Version 3 providers/context/orchestration/customization/skill system | 140/140 | `python3 -B -m unittest discover -s tests/v3 -p 'test*.py' -v` |
...
The aggregate deterministic offline suites pass 364 tests with no failures or
