...
## Release proof (executed 2026-07-23; last re-executed 2026-08-18)

Each figure in the table below is the measurement of a **2026-08-18**
...
with `docker build --no-cache --pull` on 2026-08-18, after that day's edits to the image-baked `workspaces/` files, the trusted-context extension, `Dockerfile.openclaw` itself, and the host-side recovery-lifecycle and workflow-validation scripts — so the image is derived from exactly this
