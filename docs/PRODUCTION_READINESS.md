...
## Release proof (executed 2026-07-23; last re-executed 2026-09-01)

Both dates below are managed by
...
| Exact-image gate (G6) | PASS — 10/10 against the image rebuilt from this tree |
